...
export const LoginPage = () => {
    ...
    return (
        <Center h="100%">
            <Container boxShadow="xl" borderRadius="lg" width="70%" maxWidth="400px" padding="2em" backgroundColor={subAltColor}>
                <Flex direction="column" align="center" >
                    <Box fontSize="2xl" fontWeight="bold" color={textColor} mb="1em" textAlign="center">
                        Войти через Яндекс
                    </Box>
                    <Button
                        color={textColor}
